...
const caceresCities: Location[] = [
  { slug: "caceres", name: "Cáceres", province: "Caceres", latitude: 39.4753, longitude: -6.3724 },
  ...
  { slug: "jaraiz-de-la-vera", name: "Jaraíz de la Vera", province: "Caceres", latitude: 40.0605, longitude: -5.7543 },
  { slug: "moraleja", name: "Moraleja", province: "Caceres", latitude: 40.0668, longitude: -6.6596 },
  { slug: "valencia-de-alcantara", name: "Valencia de Alcántara", province: "Caceres", latitude: 39.4115, longitude: -7.2444 },
  { slug: "logrosan", name: "Logrosán", province: "Caceres", latitude: 39.3365, longitude: -5.4928 },
];

const badajozCities: Location[] = [
  { slug: "badajoz", name: "Badajoz", province: "Badajoz", latitude: 38.8786, longitude: -6.9703 },
  { slug: "merida", name: "Mérida", province: "Badajoz", latitude: 38.9161, longitude: -6.3437 },
...
export const mapRegions: MapRegion[] = [
  {
    slug: "extremadura",
    title: "Mapa del tiempo en Extremadura",
    shortTitle: "Extremadura",
    subtitle: "Animación horaria con temperatura, lluvia, viento y ciclos de día/noche en municipios extremeños",
    center: [39.12, -6.28],
    zoom: 8,
    fitPadding: [42, 42],
    fitMaxZoom: 8,
  ...
  {
    slug: "favoritos",
    title: "Mapa del tiempo de tus favoritos",
  ...
  {
    slug: "caceres",
    title: "Mapa del tiempo en la provincia de Cáceres",
    shortTitle: "Cáceres",
    subtitle: "Evolución meteorológica por horas en localidades de la provincia de Cáceres",
    center: [39.72, -6.08],
    zoom: 8,
    fitPadding: [38, 38],
    fitMaxZoom: 9,
  ...
  {
    slug: "badajoz",
    title: "Mapa del tiempo en la provincia de Badajoz",
    shortTitle: "Badajoz",
    subtitle: "Evolución meteorológica por horas en localidades de la provincia de Badajoz",
    center: [38.7, -6.42],
    zoom: 8,
    fitPadding: [38, 38],
    fitMaxZoom: 9,
  ...
  },
  {
    ...
    shortTitle: "España",
    subtitle: "Principales ciudades con temperatura, estado del cielo y evolución horaria",
    center: [39.7, -3.75],
    zoom: 5,
    fitPadding: [18, 18],
    fitMaxZoom: 5,
    ...
    cities: [
      ...
      { slug: "malaga", name: "Málaga", province: "Málaga", latitude: 36.7202, longitude: -4.4203 },
  ...
  {
    slug: "europa",
    title: "Mapa del tiempo en Europa",
    shortTitle: "Europa",
    subtitle: "Capitales y grandes ciudades europeas con evolución horaria",
    center: [50.1, 9.5],
    zoom: 4,
    fitPadding: [18, 18],
    fitMaxZoom: 4,
    singlePlaceZoom: 8,
    cities: [
      { slug: "madrid", name: "Madrid", province: "España", latitude: 40.4165, longitude: -3.7026 },
      { slug: "lisboa", name: "Lisboa", province: "Portugal", latitude: 38.7167, longitude: -9.1333 },
      { slug: "paris", name: "París", province: "Francia", latitude: 48.8534, longitude: 2.3488 },
      { slug: "londres", name: "Londres", province: "Reino Unido", latitude: 51.5085, longitude: -0.1257 },
      { slug: "berlin", name: "Berlín", province: "Alemania", latitude: 52.5244, longitude: 13.4105 },
      { slug: "roma", name: "Roma", province: "Italia", latitude: 41.8919, longitude: 12.5113 },
      { slug: "amsterdam", name: "Ámsterdam", province: "Países Bajos", latitude: 52.374, longitude: 4.8897 },
      { slug: "bruselas", name: "Bruselas", province: "Bélgica", latitude: 50.8505, longitude: 4.3488 },
      ...
      { slug: "dublin", name: "Dublín", province: "Irlanda", latitude: 53.3331, longitude: -6.2489 },
